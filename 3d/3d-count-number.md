...
It looks complicated, but it's actually not difficult. It's mainly time-consuming.
...
<iframe height="300" style="width: 100%;" scrolling="no" title="3d-count-number" src="https://codepen.io/dvha/embed/jOXpmVB?default-tab=html%2Cresult" frameborder="no" loading="lazy" allowtransparency="true" allowfullscreen="true">
  See the Pen <a href="https://codepen.io/dvha/pen/jOXpmVB">
  3d-count-number</a> by HaDV (<a href="https://codepen.io/dvha">@dvha</a>)
